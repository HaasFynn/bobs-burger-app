...
class CharacterService(private val requestClient: RequestClient) : EntityService<Character> {
    ...
    override fun get(amount: Int): Result<List<Character>> {
    ...
    fun getByGender(gender: String, amount: Int = 0): Result<List<Character>> {
    ...
    fun getByAge(age: Int, amount: Int = 0): Result<List<Character>> {
    ...
    fun getByHair(hair: String, amount: Int = 0): Result<List<Character>> {
    ...
    fun getByOccupation(occupation: String, amount: Int = 0): Result<List<Character>> {
    ...
    fun getByVoiceActor(voiceActor: VoiceActor, amount: Int = 0): Result<List<Character>> {
